...
int main(int, char**)
{
	...
	namedWindow("problem2_lena_gray", WINDOW_AUTOSIZE);
	imshow("problem2_lena_gray", img2_Mat_gray);
	imwrite("problem2_lena_gray.bmp", img2_Mat_gray);
	...
	namedWindow("problem3_image_gray", WINDOW_AUTOSIZE);
	imshow("problem3_image_gray", img3_Mat_gray);
	imwrite("problem3_image_gray.bmp", img3_Mat_gray);
